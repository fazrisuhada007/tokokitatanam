...
<div class="wpfm-menu-wrapper wpfm-<?php echo $template; ?>" menu-id="<?php echo $menu_data->id; ?>" data-pos-offset-var="<?php echo isset($wpfm_settings['menu_enable_offset_to_position']) && $wpfm_settings['menu_enable_offset_to_position'] == 1 ? 1 : 0; ?>" data-disable-double-touch = "<?php echo isset($wpfm_settings['menu_disable_double_touch']) && $wpfm_settings['menu_disable_double_touch'] == 1 ? 1 : 0; ?>">
