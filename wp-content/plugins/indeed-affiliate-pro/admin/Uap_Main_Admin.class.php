...
if (!class_exists('Uap_Main_Admin')){
	class Uap_Main_Admin{
		...
		public function add_style_scripts(){
			...
			wp_enqueue_media();
			wp_register_script('uap_admin_js', UAP_URL . 'assets/js/admin-functions.js', array(), null);
			...
			if ($is_plugin_page){
				...
				wp_register_script('uap_public', UAP_URL . 'assets/js/public-functions.js', array(), null);
